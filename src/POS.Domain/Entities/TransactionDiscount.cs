...
/// <summary>
/// Represents a discount applied at the transaction level. UNIQUE on TransactionId.
/// Amount must not exceed the transaction subtotal.
/// </summary>
public class TransactionDiscount
{
    ...
    /// <summary>
    /// One discount per transaction (UNIQUE constraint).
    /// </summary>
    ...
    /// <summary>
    /// Computed discount amount. Must be >= 0 and <= transaction subtotal.
    /// </summary>
